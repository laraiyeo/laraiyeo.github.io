...
async function loadTeams() {
  try {
    // Use ESPN NFL API like other NFL files
...
async function createTeamCard(team) {
  const logoUrl = `https://a.espncdn.com/i/teamlogos/nfl/500/${team.abbreviation}.png`;

  const abbreviation = team.abbreviation || 'NFL';
  ...
  return `
    <div class="team-card" data-team-id="${team.id}">
      ...
      <div class="team-details">
        ...
        <div class="team-division" style="color: #${team.color || '000000'};">${abbreviation} - NFL</div>
