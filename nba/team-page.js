...
async function showOverallStats() {
  ...
  const response = await fetch(`https://sports.core.api.espn.com/v2/sports/basketball/leagues/nba/seasons/${seasonYear}/types/2/athletes/${selectedPlayer.id}/statistics?lang=en&region=us`);
  const data = await response.json();
