...
export class ChatUtils {
  ...
  static isChatAvailable(gameData) {
    ...
    const possibleDateFields = [
      ...
      { key: 'gameData.datetime.dateTime', value: gameData.gameData?.datetime?.dateTime },
      { key: 'gameData.datetime.officialDate', value: gameData.gameData?.datetime?.officialDate },
