                      ...
                      return (
                        <>
                          ...
                          >
                            ...
                            <Text
                              style={[
                                styles.nflPlayShareCardTeamName,
                                { color: "#fff" },
                              ]}
                            >
                              {teamName}
                          ...
                          <View
                            style={[
                              styles.nflPlayShareCardInfoBar,
                              {
                                backgroundColor: theme.surfaceSecondary,
                                borderBottomColor: theme.border,
                              },
                          ...
                          >
                            <Text
                              style={[
                                styles.nflPlayShareCardQuarter,
                                { color: theme.text },
                              ]}
                            >
                              Q{period} {clock} •{" "}
                          ...
                          <View
                            style={[
                              styles.nflPlayShareCardScoreRow,
                              { borderBottomColor: theme.border },
                            ]}
                          >
                            <View style={styles.nflPlayShareCardScoreBlock}>
                              ...
                              <Text
                                style={[
                                  styles.nflPlayShareCardScoreSeparator,
                                  { color: theme.textSecondary },
                                ]}
                              >
                                -
                            ...
                            <View
                              style={[
                                styles.nflPlayShareCardWinProbability,
                                { backgroundColor: teamColor },
                              ]}
                            >
                              <Text
                                style={[
                                  styles.nflPlayShareCardWinProbText,
                                  { color: "#fff" },
                                ]}
                              >
                          ...
                          <View
                            style={[
                              styles.nflPlayShareCardPlayDescription,
                              { backgroundColor: theme.surfaceSecondary },
                            ]}
                          >
                            <Text
                              style={[
                                styles.nflPlayShareCardPlayText,
                                { color: theme.text },
                              ]}
                            >
                              {playText}
                          ...
                          {players.length > 0 &&
                            (() => {
                              ...
                              return (
                                <View
                                  style={[
                                    styles.nflPlayShareCardPlayersSection,
                                    { borderTopColor: theme.border },
                                  ]}
                                >
                                  ...
                                  <View
                                    style={[
                                      styles.nflPlayShareCardPlayerRow,
                                      { borderBottomColor: theme.border },
                                    ]}
                                  >
                                    <View
                                      style={styles.nflPlayShareCardPlayerInfo}
                                    >
                                      <Image
                                        source={{ uri: mainPlayerHeadshot }}
                                        style={[
                                          styles.nflPlayShareCardPlayerImage,
                                          { backgroundColor: teamColor + "88" },
                                        ]}
                                      />
                                      <View
                                        style={
                                          styles.nflPlayShareCardPlayerDetails
                                        }
                                      >
                                        <Text
                                          style={[
                                            styles.nflPlayShareCardPlayerName,
                                            { color: theme.text },
                                          ]}
                                        >
                                          {mainPlayerDisplay}
                                        ...
                                        {otherPlayers.map((player, idx) => {
                                          ...
                                          return (
                                            <Text
                                              key={idx}
                                              style={[
                                                styles.nflPlayShareCardOtherPlayerName,
                                                { color: theme.textSecondary },
                                              ]}
                                            >
                                              {otherPlayerDisplay}
