...
const API_URL = 'https://site.api.espn.com/apis/site/v2/sports/basketball/wnba/injuries';
                ...
                <View key={`${dateKey}-${i}`} style={[styles.row, { borderBottomColor: theme.border }]}> 
                  <View style={styles.headshotWrap}>
                    ...
                    {entry.athlete.team?.id && (
                      <Image source={{ uri: `https://a.espncdn.com/combiner/i?img=/i/teamlogos/wnba/500${isDarkMode ? '-dark' : ''}/${entry.athlete.team.abbreviation.toLowerCase()}.png&w=200&h=200` }} style={styles.teamLogo} />
                    )}
                  </View>
