...
const WNBAPlayerPageScreen = ({ route, navigation }) => {
  ...
  const getHeadshotSource = (p) => {
    try {
      ...
      if (id)
        return {
          uri: convertToHttps(
            `https://a.espncdn.com/combiner/i?img=/i/headshots/wnba/players/${id}.png&w=88&h=88`
          ),
        };
    } catch (e) {
      // fall through
  ...
  const getTeamLogoUrl = (teamParam, useDarkMode = isDarkMode) => {
    ...
    if (failedLogos.has(primaryKey)) {
      return `https://a.espncdn.com/combiner/i?img=/i/teamlogos/wnba/${
  ...
  const getTeamLogoFallbackUrl = (teamParam, useDarkMode = isDarkMode) => {
    ...
    const normalized = String(normalizedToken).toLowerCase();
    return {
      uri: `https://a.espncdn.com/combiner/i?img=/i/teamlogos/wnba/500/${normalized}.png&w=200&h=200`,
    };
  };
  ...
  const fetchPlayerData = async () => {
    try {
      ...
      const basicPlayerData = {
        ...
        headshot: {
          href: `https://a.espncdn.com/combiner/i?img=/i/headshots/wnba/players/full/${playerId}.png`,
        },
      };
