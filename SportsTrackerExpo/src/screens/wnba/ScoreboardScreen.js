...
const WNBAGridCard = ({
  ...
  const awayLogo =
    getTeamLogoUrl("wnba", away?.abbreviation) ||
    getWnbaLogoUrl(away, isDarkMode);
  const homeLogo =
    getTeamLogoUrl("wnba", home?.abbreviation) ||
    getWnbaLogoUrl(home, isDarkMode);
          ...
          {isScheduled ? (
            awayLogo && !awayLogoError ? (
              ...
              >
                <Text
                  style={[
                    wnbaGridStyles.teamLogoPlaceholderText,
                    { fontSize: 11 },
                  ]}
                >
                  {awayAbbr || "A"}
