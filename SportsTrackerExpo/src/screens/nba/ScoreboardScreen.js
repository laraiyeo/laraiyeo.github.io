...
const NBAScoreboardScreen = ({ navigation }) => {
  ...
  const getStatusColor = (item) => {
    ...
    if (isLiveGame(item)) return colors.error;
        ...
        <View style={styles.gameContent}>
          ...
          >
            <View style={styles.teamInfo}>
              <Image
                source={{ uri: getTeamLogoUrl('nba', normalizeAbbreviation(item.awayTeam.abbreviation)) }}
          ...
          >
            <View style={styles.teamInfo}>
              <Image
                source={{ uri: getTeamLogoUrl('nba', normalizeAbbreviation(item.homeTeam.abbreviation)) }}
                style={styles.teamLogo}
                defaultSource={require('../../../assets/nba.png')}
              />
              <View style={styles.teamDetails}>
