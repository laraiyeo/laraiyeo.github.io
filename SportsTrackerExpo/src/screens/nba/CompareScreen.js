...
const CompareScreen = ({ route }) => {
  ...
  const [player1Year, setPlayer1Year] = useState(getNBAYear());
    ...
    return (
      <View style={[styles.playerCard, { 
        ...
        <View style={styles.playerImageContainer}>
          <Image
            source={{ 
              uri: player.headshot?.href || `https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/${player.id}.png`
            }}
