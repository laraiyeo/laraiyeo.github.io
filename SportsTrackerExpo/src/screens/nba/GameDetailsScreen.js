...
const HeaderGradient = ({ awayColor, homeColor, theme, height }) => (
  <View style={[StyleSheet.absoluteFill, { height }]} pointerEvents="none">
    ...
    >
      <Defs>
        <LinearGradient id="nbaHeaderGrad" x1="00%" y1="0%" x2="100%" y2="0%">
      ...
      <Rect width={width} height={height} fill="url(#nbaHeaderGrad)" />
    </Svg>
  </View>
);
...
const NBAPlayerDetailModal = ({
  ...
  const teamLogo =
    playerTeam?.logo || (teamAbbrev ? getTeamLogoUrl("nba", teamAbbrev) : null);
  ...
  const statRangeByKey = (() => {
    ...
    sourcePlayers.forEach((p, pIdx) => {
      ...
      NBA_STAT_KEYS.forEach((key) => {
        ...
        const value = parseNbaStatNum(key, raw);
                ...
                {compareCandidates.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <View style={nbaModalStyles.compareRow}>
                          <View
                            style={[
                          ...
                          >
                            ...
                            {!!pLogo && (
                              <Image
                                source={{ uri: pLogo }}
                                style={[
                                  nbaModalStyles.compareTeamLogo,
                                  {
                                    borderColor: pColor,
            ...
            statRows.map((row, idx) => {
              ...
              return (
                <React.Fragment key={row.key}>
                  <View style={nbaModalStyles.statRow}>
                    <Text
                      style={[
                      ...
                      <View style={nbaModalStyles.statRowRight}>
                        <Text
                          style={[
                            ...
                            {
                              color: isPM
                                ? getNbaStatColor(cmp.key, cmp.value, theme)
                                : theme.text,
                            },
                          ]}
                        >
      ...
      >
        ...
        <View style={nbaRosterStyles.miniGameInfo}>
          ...
          <View style={nbaRosterStyles.miniGameMeta}>
            <Text
              style={[nbaRosterStyles.miniGameOpponent, { color: theme.text }]}
            >
              {game.atVs} {game.opponent?.abbreviation || "OPP"}
            </Text>
            <Text
              style={[
                nbaRosterStyles.miniGameDate,
                { color: theme.textSecondary },
              ]}
            >
            ...
            {injuries.length > 0 && (
              ...
              >
                <View style={nbaRosterStyles.scheduleSectionHeader}>
                  ...
                  <Text
                    style={[
                      nbaRosterStyles.scheduleSectionTitle,
                      { color: theme.text },
                    ]}
                  >
...
const NBAPlaysTabSection = ({
  ...
  const preparedPlays = useMemo(() => {
    ...
    const rows = rawPlays.map((play, idx) => {
      ...
      const scorerHeadshot =
        ...
        (scorerId
          ? `https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/${scorerId}.png&w=300`
          : null);
      ...
      const assistHeadshot =
        ...
        (assistId
          ? `https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/${assistId}.png&w=300`
          : null);
      ...
      const teamLogo = isAway
        ? getTeamLogoUrl("nba", awayTeam.abbr)
        : isHome
          ? getTeamLogoUrl("nba", homeTeam.abbr)
          : null;
  ...
  const openShareFromPlay = useCallback(() => {
    ...
    const p = {
      ...
      rawPlay: row.rawPlay,
      awayLogoUri: getTeamLogoUrl("nba", awayTeam.abbr),
      homeLogoUri: getTeamLogoUrl("nba", homeTeam.abbr),
...
// ─── NBA Linescore Table (NHL-style card with horizontal scroll) ───
const NBALinescoreTable = ({
  details,
  theme,
  colors,
  getTeamLogoUrl,
  ...
  return (
    <View
      style={[nbaStatsStyles.linescoreCard, { backgroundColor: theme.surface }]}
    >
      <View style={{ flexDirection: "row" }}>
        <View style={{ width: LABEL_W }}>
          <View
            style={[
              nbaStatsStyles.linescoreCell,
              {
                height: ROW_H,
          ...
          >
            <Text
              style={[nbaStatsStyles.linescoreTeamAbbr, { color: theme.text }]}
            >
              {awayAbbr}
            </Text>
          </View>
          ...
          <View style={{ flexDirection: "row" }}>
            {periodLabels.map((label, idx) => (
              ...
              >
                <Text
                  style={[
                    nbaStatsStyles.linescorePeriodNum,
                    { color: theme.textSecondary },
                  ]}
                >
                  {label}
          ...
          <View style={{ flexDirection: "row" }}>
            {periodLabels.map((_, idx) => (
              ...
              >
                <Text
                  style={[
                    nbaStatsStyles.linescoreRunsText,
                    { color: theme.text },
                  ]}
                >
        ...
        <View
          style={[
            nbaStatsStyles.linescoreTotalsSection,
            { borderLeftColor: borderCol },
          ]}
        >
          <View
            style={[
              nbaStatsStyles.linescoreTotalsRow,
              {
                height: ROW_H,
                backgroundColor: headerBg,
                borderBottomColor: borderCol,
          ...
          >
            <View style={{ width: TOTAL_W, alignItems: "center" }}>
              <Text
                style={[
                  nbaStatsStyles.linescoreTotalHeader,
                  { color: theme.textSecondary },
                ]}
              >
                T
          ...
          >
            <View style={{ width: TOTAL_W, alignItems: "center" }}>
              <Text
                style={[
                  nbaStatsStyles.linescoreTotalVal,
                  { color: theme.text },
                ]}
              >
                {awayTotal}
...
// ─── NBA Stats Section (NHL-style bar fills, no faceoff/SOG) ───
const NBAStatsSection = ({ details, theme, colors, isDarkMode }) => {
  if (!details?.boxscore?.teams) return null;
  const teams = details.boxscore.teams;
    ...
    <>
      {rows.length !== 0 && (
        ...
        >
          <View
            style={[
              nbaStatsStyles.headerRow,
              { borderBottomColor: theme.border },
            ]}
          >
            <Text style={[nbaStatsStyles.headerTitle, { color: theme.text }]}>
              Stats
            </Text>
          </View>
          <View style={nbaStatsStyles.body}>
            {rows.length === 0 ? (
              <Text
                style={[
                  nbaStatsStyles.emptyText,
              ...
              rows.map((row) => {
                ...
                return (
                  <View key={row.key} style={nbaStatsStyles.statRowWrap}>
                    <View style={nbaStatsStyles.statValueRow}>
                      <Text
                        style={[
                          nbaStatsStyles.statValueText,
                          { color: theme.text },
                        ]}
                      >
                        {row.awayVal}
                    ...
                    <View
                      style={[
                        nbaStatsStyles.statBarTrack,
                        { backgroundColor: theme.surfaceSecondary },
                      ]}
                    >
                      <View
                        style={[
                          nbaStatsStyles.statBarFillLeft,
                          {
                      ...
                      <View
                        style={[
                          nbaStatsStyles.statBarFillRight,
                          {
                    ...
                    <Text
                      style={[
                        nbaStatsStyles.statCategoryLabel,
                        { color: theme.textSecondary },
                      ]}
                      numberOfLines={2}
                    >
...
// ─── NBA Leaders Section (NHL three-stars style per team) ───
const NBALeadersSection = ({
  details,
  theme,
  colors,
  getTeamLogoUrl,
  ...
  return (
    ...
    >
      <View
        style={[nbaStatsStyles.headerRow, { borderBottomColor: theme.border }]}
      >
        <Text style={[nbaStatsStyles.headerTitle, { color: theme.text }]}>
          Leaders
        </Text>
      ...
      {sortedLeaders.map((teamLeaders, teamIdx) => {
        ...
        return (
          <View
            key={`leaders-${teamIdx}`}
            style={[
              nbaStatsStyles.leadersTeamBlock,
          ...
          >
            <View
              style={[
                nbaStatsStyles.leadersTeamHeader,
            ...
            >
              ...
              />
              <Text
                style={[nbaStatsStyles.leadersTeamName, { color: theme.text }]}
              >
            ...
            {teamLeaders.leaders?.map((category, catIdx) => (
              <View
                key={`cat-${catIdx}`}
                style={nbaStatsStyles.leadersCategoryBlock}
              >
                <Text
                  style={[
                    nbaStatsStyles.leadersCategoryTitle,
                    { color: theme.textSecondary },
                  ]}
                >
                ...
                {category.leaders?.slice(0, 3).map((leader, li) => {
                  ...
                  return (
                    ...
                    >
                      <View
                        style={[
                          nbaStatsStyles.leaderHeadshotWrap,
                          {
                            borderColor: teamColor,
                            backgroundColor: `${teamColor}33`,
                          },
                      ...
                      >
                        {headshot ? (
                          <Image
                            source={{ uri: headshot }}
                            style={nbaStatsStyles.leaderHeadshot}
                            contentFit="cover"
                          />
                        ) : (
                          <View
                            style={[
                              nbaStatsStyles.leaderHeadshot,
                              {
                                alignItems: "center",
                                justifyContent: "center",
                              },
                        ...
                        {!!teamLogoUri && (
                          <View
                            style={[
                              nbaStatsStyles.leaderTeamBadge,
                              {
                                borderColor: teamColor,
                                backgroundColor: `${teamColor}33`,
                              },
                      ...
                      <View style={nbaStatsStyles.leaderNameCol}>
                        <Text
                          style={[
                            nbaStatsStyles.leaderDisplayName,
                            { color: theme.text },
                          ]}
                          numberOfLines={1}
                        >
...
// ─── NBA Series Summary Section (NHL-style) ───
const NBASeriesSummarySection = ({
  details,
  theme,
  colors,
  homeColor,
  ...
  const awayLogoUri =
    ...
    getTeamLogoUrl("nba", awayAbbr);
  const homeLogoUri =
    homeComp.team?.logos?.[isDarkMode ? 1 : 0]?.href ||
    getTeamLogoUrl("nba", homeAbbr);
  ...
  return (
    <View style={[nbaSeriesStyles.card, { backgroundColor: theme.surface }]}>
      <View
        style={[nbaSeriesStyles.headerRow, { borderBottomColor: theme.border }]}
      >
        <Text style={[nbaSeriesStyles.headerTitle, { color: theme.text }]}>
          SEASON SERIES
        </Text>
        <TouchableOpacity
          style={[
            nbaSeriesStyles.homeFilterBtn,
            {
        ...
        >
          {homeLogoUri ? (
            <Image
              ...
              style={nbaSeriesStyles.homeFilterLogo}
              contentFit="contain"
            />
          ) : (
            <View
              style={[
                nbaSeriesStyles.homeFilterLogoFallback,
                { backgroundColor: theme.surfaceSecondary },
              ]}
            >
              <Text
                style={[
                  nbaSeriesStyles.homeFilterLogoFallbackText,
                  { color: theme.textSecondary },
                ]}
              >
                {homeAbbr.charAt(0)}
          ...
          <Text
            style={[
              nbaSeriesStyles.homeFilterText,
      ...
      <View style={nbaSeriesStyles.bodyRow}>
        <View
          style={[nbaSeriesStyles.sideBlock, nbaSeriesStyles.sideBlockLeft]}
        >
          {awayLogoUri ? (
            <Image
              source={{ uri: awayLogoUri }}
              style={nbaSeriesStyles.logo}
              contentFit="contain"
            />
          ) : (
            <View
              style={[
                nbaSeriesStyles.logoPlaceholder,
                { backgroundColor: theme.surfaceSecondary },
              ]}
            >
              <Text
                style={[
                  nbaSeriesStyles.logoInitial,
                  { color: theme.textSecondary },
                ]}
              >
                {awayAbbr.charAt(0)}
          ...
          <Text style={[nbaSeriesStyles.winCount, { color: theme.text }]}>
            {awayWinsCount}
          </Text>
        </View>
        <View style={nbaSeriesStyles.centerBlock}>
          <Text
            style={[nbaSeriesStyles.vsText, { color: theme.textSecondary }]}
          >
            VS
          </Text>
        </View>
        <View
          style={[nbaSeriesStyles.sideBlock, nbaSeriesStyles.sideBlockRight]}
        >
          <Text style={[nbaSeriesStyles.winCount, { color: theme.text }]}>
            {homeWinsCount}
          </Text>
      ...
      >
        <View
          style={[
            nbaSeriesStyles.summaryFooterFill,
            {
              flex: awayFlex,
              backgroundColor: awayColor,
...
// ─── NBA Series Match Card (NHL-style with gradient) ───
const NBASeriesMatchCard = ({
  event,
  details,
  theme,
  colors,
  ...
  const leftLogoUri =
    ...
    getTeamLogoUrl("nba", leftAbbr);
  const rightLogoUri =
    rightTeam.team?.logos?.[isDarkMode ? 1 : 0]?.href ||
    getTeamLogoUrl("nba", rightAbbr);
  ...
  const gradId = `nba_series_${String(event.id ?? Math.random()).replace(/[^a-zA-Z0-9_]/g, "_")}`;
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        nbaSeriesStyles.matchCard,
        { backgroundColor: theme.surface, borderColor: theme.border },
      ]}
    >
      <View style={nbaSeriesStyles.matchCardTopRow}>
        <Text
          style={[
            nbaSeriesStyles.matchCardTopText,
            { color: theme.textSecondary },
          ]}
          numberOfLines={1}
        >
      ...
      >
        ...
        <View style={nbaSeriesStyles.matchCardInner}>
          <View style={nbaSeriesStyles.matchTeamSide}>
            {leftLogoUri ? (
              <Image
                source={{ uri: leftLogoUri }}
                style={[
                  nbaSeriesStyles.matchTeamLogo,
              ...
              <View
                style={[
                  nbaSeriesStyles.matchTeamLogo,
                  nbaSeriesStyles.logoFallback,
                  { backgroundColor: `${leftColor}40` },
                ]}
              >
                <Text
                  style={[
                    nbaSeriesStyles.logoFallbackText,
                    { color: theme.text },
                  ]}
                >
                  {leftAbbr.charAt(0)}
            ...
            <View style={nbaSeriesStyles.matchTeamTextCol}>
              <Text
                style={[
                  nbaSeriesStyles.matchTeamName,
                  {
                    color: theme.text,
                    opacity: !hasScore ? 1 : leftWon ? 1 : 0.55,
          ...
          <View style={nbaSeriesStyles.matchScoreBlock}>
            {live && (
              <Text
                style={[
                  nbaSeriesStyles.matchStatusText,
            ...
            {hasScore ? (
              <View style={nbaSeriesStyles.matchScoreRow}>
                <Text
                  style={[
                    nbaSeriesStyles.matchScore,
                    {
                      color: live
                        ? theme.error
                        : leftWon
                ...
                <Text
                  style={[
                    nbaSeriesStyles.matchScoreDash,
          ...
          <View style={nbaSeriesStyles.matchTeamSideAway}>
            <View
              style={[
                nbaSeriesStyles.matchTeamTextCol,
                nbaSeriesStyles.matchTeamTextColAway,
              ]}
            >
              <Text
                style={[
                  nbaSeriesStyles.matchTeamName,
                  nbaSeriesStyles.matchTeamNameAway,
                  {
                    color: theme.text,
...
// ─── Styles for NHL-style NBA components ───
const nbaStatsStyles = StyleSheet.create({
  linescoreCard: {
    marginHorizontal: 12,
    marginTop: 14,
    borderRadius: 14,
...
const nbaSeriesStyles = StyleSheet.create({
  card: {
    marginHorizontal: 12,
    marginTop: 14,
    borderRadius: 14,
          ...
          <View style={styles.simpleLeagueRow}>
            ...
            >
              {[
                ...
                details?.header?.season?.type === 1 ? "NBA" : null,
                details?.header?.gameNote ||
                  (details?.header?.season?.type === 1 ? "Preseason" : "NBA"),
              ]
                .filter(Boolean)
                .join(" · ")}
            </Text>
          ...
          <View style={styles.simpleMainRow}>
            ...
            <SimpleTeamDisplay
              ...
              logo={
                away?.team?.logo ||
                away?.logo ||
                getTeamLogoUrl("nba", away?.team?.abbreviation)
              }
              score={awayScoreNum}
              side="away"
            ...
            <SimpleTeamDisplay
              ...
              logo={
                home?.team?.logo ||
                home?.logo ||
                getTeamLogoUrl("nba", home?.team?.abbreviation)
              }
              score={homeScoreNum}
              side="home"
              isPre={getGameStatus().isPre}
          ...
          <View style={styles.tabContent}>
            ...
            {activeTab === "series" && (
              <View style={{ paddingTop: 6, paddingBottom: 80 }}>
                ...
                />
                <View style={nbaSeriesStyles.matchesWrap}>
                  {seriesEvents
