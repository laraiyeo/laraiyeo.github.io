  ...
  const fetchData = async () => {
    ...
    try {
      ...
      (json.injuries || []).forEach((teamEntry) => {
        const team =
          teamEntry.displayName || teamEntry.team?.displayName || null;
        ...
        renderItem={({ item: dateKey }) => (
          <View style={{ marginBottom: 16 }}>
            <Text
              ...
              style={[styles.dateHeader, { color: theme.text }]}
            >
              {dateKey}
            </Text>
            {(grouped[dateKey] || []).map((entry, i) => {
              ...
              if (abbrU.includes("O")) {
                abbrColor = theme.error;
                boxBg = theme.error + "33";
              } else if (abbrU.includes("Q") || abbrU.includes("D")) {
                abbrColor = theme.warning;
                boxBg = theme.warning + "33";
              }
                      ...
                      <Image
                        source={{
                          uri: `https://a.espncdn.com/combiner/i?img=/i/teamlogos/nba/500${
                            isDarkMode ? "-dark" : ""
                          }/${entry.athlete.team.abbreviation.toLowerCase()}.png&w=200&h=200`,
                        }}
                    ...
                    {details && (
                      ...
                      >
                        ...
                        >
                          <Text
                            allowFontScaling={false}
                            style={{ color: abbrColor, fontWeight: "700" }}
                          >
                            {abbr}
                          </Text>
                        </View>
