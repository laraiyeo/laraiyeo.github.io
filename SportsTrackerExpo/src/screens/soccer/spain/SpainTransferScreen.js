...
const SpainTransferScreen = ({ navigation, route }) => {
  ...
  const loadTransferData = async () => {
    try {
      ...
      const response = await fetch(
        convertToHttps(
          "https://sports.core.api.espn.com/v2/sports/soccer/leagues/esp.1/transactions?limit=1000"
        )
      );
...
export default SpainTransferScreen;
