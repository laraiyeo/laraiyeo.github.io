...
import { EuropaConferenceService } from '../../../services/soccer/EuropaConferenceService';

const EuropaConferenceScreen = () => {
  ...
  const leagueId = route.params?.leagueId || 'europa-conference';
  const leagueName = route.params?.leagueName || 'Europa Conference';
  ...
  const loadMatches = async () => {
    try {
      const data = await EuropaConferenceService.getScoreboard();
  ...
  const loadStandings = async () => {
    try {
      const data = await EuropaConferenceService.getStandings();
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={[styles.competitionIcon, { color: colors.primary }]}>🥉</Text>
      </View>
...
export default EuropaConferenceScreen;