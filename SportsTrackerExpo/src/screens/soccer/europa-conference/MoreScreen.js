...
import UECLBracketScreen from "./UECLBracketScreen";
...
const MoreScreen = ({ navigation, route }) => {
  ...
  const competitionCode = "uefa.europa.conf";
      ...
      >
        ...
        <View style={styles.textWrap}>
          ...
          <Text
            ...
            style={[styles.subtitle, { color: theme.textTertiary }]}
          >
            Europa Conference League Bracket
          </Text>
        </View>
      </TouchableOpacity>
      ...
      <FIFAWorldStatsScreen
        ...
        route={{
          params: {
            ...
            competitionName: "Europa Conference",
          },
        }}
        hideSelector={true}
      />
  ...
  if (selected === "bracket") return renderBracket();
  return renderMenu();
};
