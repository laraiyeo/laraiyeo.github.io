...
const UELScoreboardScreen = ({ navigation, route }) => {
  ...
  const handleGamePress = (game) => {
    ...
    // Try to map ESPN team names to upstream diary match id
    try {
      ...
      console.warn("UELScoreboardScreen: live tracker lookup failed", err);
      navigation.navigate("UELGameDetails", {
        gameId: game.id,
        sport: "Europa League",
        competition: game.competitionName || "UEL",
          ...
          <View style={styles.teamSection}>
            ...
            <Text
              ...
              style={[
                ...
                {
                  color: isFavorite(homeTeam?.team?.id, "uefa europa")
                    ? colors.primary
                    : theme.text,
                },
                matchStatus.isPost &&
            ...
            >
              {isFavorite(homeTeam?.team?.id, "uefa europa") ? "★ " : ""}
          ...
          <View style={styles.teamSection}>
            ...
            <Text
              ...
              style={[
                styles.teamAbbreviation,
                {
                  color: isFavorite(awayTeam?.team?.id, "uefa europa")
                    ? colors.primary
                    : theme.text,
                },
                matchStatus.isPost &&
            ...
            >
              {isFavorite(awayTeam?.team?.id, "uefa europa") ? "★ " : ""}
