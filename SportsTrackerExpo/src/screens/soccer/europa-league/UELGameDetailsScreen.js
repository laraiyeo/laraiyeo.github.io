...
const UELGameDetailsScreen = ({ route, navigation }) => {
  ...
  const renderPlayerPopup = () => {
    ...
    if (selectedPlayer.teamType === 'home') {
      teamColor = EuropaLeagueServiceEnhanced.getTeamColorWithAlternateLogic(homeTeam?.team) || '#007bff';
    } else if (selectedPlayer.teamType === 'away') {
      teamColor = EuropaLeagueServiceEnhanced.getTeamColorWithAlternateLogic(awayTeam?.team) || '#28a745';
    }
