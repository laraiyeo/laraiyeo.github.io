...
const EnglandTransferScreen = ({ navigation, route }) => {
  ...
  const loadTransferData = async () => {
    try {
      ...
      const response = await fetch(convertToHttps('https://sports.core.api.espn.com/v2/sports/soccer/leagues/eng.1/transactions?limit=1000'));
    ...
    return (
      <View style={[styles.loadingContainer, { backgroundColor: theme.background }]}>
        ...
        <Text allowFontScaling={false} style={[styles.loadingText, { color: theme.text }]}>
          Loading Premier League transfers...
        </Text>
      </View>
    );
  }
...
export default EnglandTransferScreen;
