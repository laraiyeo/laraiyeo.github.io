...
const EnglandGameDetailsScreen = ({ route, navigation }) => {
  ...
  const renderPlayerPopup = () => {
    ...
    if (selectedPlayer.teamType === 'home') {
      teamColor = EnglandServiceEnhanced.getTeamColorWithAlternateLogic(homeTeam?.team) || '#007bff';
    } else if (selectedPlayer.teamType === 'away') {
      teamColor = EnglandServiceEnhanced.getTeamColorWithAlternateLogic(awayTeam?.team) || '#28a745';
    }
