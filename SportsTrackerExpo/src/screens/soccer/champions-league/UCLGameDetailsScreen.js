...
const UCLGameDetailsScreen = ({ route, navigation }) => {
  ...
  const renderPlayerPopup = () => {
    ...
    if (selectedPlayer.teamType === 'home') {
      teamColor = ChampionsLeagueServiceEnhanced.getTeamColorWithAlternateLogic(homeTeam?.team) || '#007bff';
    } else if (selectedPlayer.teamType === 'away') {
      teamColor = ChampionsLeagueServiceEnhanced.getTeamColorWithAlternateLogic(awayTeam?.team) || '#28a745';
    }
