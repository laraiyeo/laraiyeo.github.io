...
const HeaderGradient = ({ awayColor, homeColor, theme, height }) => (
  <View style={[StyleSheet.absoluteFill, { height }]} pointerEvents="none">
    ...
    >
      <Defs>
        <LinearGradient id="championsLeagueHeaderGrad" x1="00%" y1="0%" x2="100%" y2="0%">
      ...
      <Rect width={width} height={height} fill="url(#championsLeagueHeaderGrad)" />
    </Svg>
  </View>
);
...
const UCLGameDetailsScreen = ({ route, navigation }) => {
      ...
      if (
        ...
        if (gameId && contextTeamId) {
          try {
            ...
            const rosterUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/uefa.champions/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster?lang=en&region=us`;
            ...
            if (foundAthleteId) {
              const statsUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/uefa.champions/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster/${foundAthleteId}/statistics/0?lang=en&region=us`;
              console.log(
      ...
      >
        ...
        <View style={styles.simpleLeagueRow}>
          <Text
            ...
            numberOfLines={1}
          >
            {gameData.competitionName || "UCL World Cup"}
          </Text>
        </View>
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  ...
                  {
                    color: isFavorite(homeTeamData?.team?.id, "champions league")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (homeIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(homeTeamData?.team?.id, "champions league") ? "★ " : ""}
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  styles.simpleTeamName,
                  {
                    color: isFavorite(awayTeamData?.team?.id, "champions league")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (awayIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(awayTeamData?.team?.id, "champions league") ? "★ " : ""}
        ...
        {/* Scorers Box (UCL-specific addition) */}
  ...
  const renderStatsTab = () => {
    ...
    let homeColor =
      ChampionsLeagueServiceEnhanced.getTeamColorWithAlternateLogic(homeTeam?.team) ||
      "#007bff";
    let awayColor =
      ChampionsLeagueServiceEnhanced.getTeamColorWithAlternateLogic(awayTeam?.team) ||
      "#28a745";
          ...
          onPress={() => {
            ...
            if (event.id) {
              ...
              const competitionHint =
                ...
                event.leagueName ||
                null;
              navigation.navigate("ChampionsLeagueGameDetails", {
                gameId: event.id,
                sport: "UCL",
                competitionHint,
              });
  ...
  const fetchLineupData = async (sourceData = null) => {
    ...
    try {
      ...
      console.log("[UCLGameDetails] Extracted lineups from summary:", {
            ...
            <View style={styles.playerModalHeader}>
              ...
              <View style={styles.playerHeaderInfo}>
                ...
                <View style={styles.playerModalNameSection}>
                  <TouchableOpacity
                    onPress={() => {
                      navigation.navigate("ChampionsLeaguePlayerPage", {
                        playerId: id,
                        playerName: name,
