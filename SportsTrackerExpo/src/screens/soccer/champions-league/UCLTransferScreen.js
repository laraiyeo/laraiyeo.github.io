...
const UCLTransferScreen = ({ navigation, route }) => {
  ...
  const loadTransferData = async () => {
    try {
      ...
      const response = await fetch(convertToHttps('https://sports.core.api.espn.com/v2/sports/soccer/leagues/uefa.champions/transactions?limit=1000'));
    ...
    return (
      <View style={[styles.loadingContainer, { backgroundColor: theme.background }]}>
        ...
        <Text style={[styles.loadingText, { color: theme.text }]}>
          Loading Champions League transfers...
        </Text>
      </View>
    );
  }
...
export default UCLTransferScreen;
