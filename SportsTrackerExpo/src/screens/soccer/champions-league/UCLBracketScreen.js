...
const UCLBracketScreen = ({ navigation, route }) => {
  ...
  // Fetch standings with shared cache
  const fetchStandings = async () => {
    try {
      const leagueCode = LEAGUES["Champions League"].code;
        ...
        <View style={styles.pairingContent}>
          <View style={styles.pairingLeft}>
            {matchups.map((matchup, index) => {
              ...
              // determine winner color for this aggregate
            ...
            {matchups.map((matchup, index) => {
              ...
              return clickableRight ? (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    console.log(
                      "UCL pairing right press -> r16Matchup",
                      r16Matchup?.homeTeam?.id,
                      r16Matchup?.awayTeam?.id,
                    );
            ...
            <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
              <Text
                ...
                style={[
                  ...
                  {
                    color:
                      firstIsWinner && !isTie ? colors.primary : theme.text,
                  },
                ]}
              >
                {firstScore}
            ...
            <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
              <Text
                ...
                style={[
                  ...
                  {
                    color:
                      homeTeam.id === winnerId ? colors.primary : theme.text,
                  },
                ]}
              >
                {homeScore}
            ...
            <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
              <Text
                ...
                style={[
                  ...
                  {
                    color:
                      awayTeam.id === winnerId ? colors.primary : theme.text,
                  },
                ]}
              >
                {awayScore}
