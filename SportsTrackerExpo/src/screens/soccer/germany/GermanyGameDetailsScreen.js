...
const HeaderGradient = ({ awayColor, homeColor, theme, height }) => (
  <View style={[StyleSheet.absoluteFill, { height }]} pointerEvents="none">
    ...
    >
      <Defs>
        <LinearGradient id="germanyHeaderGrad" x1="00%" y1="0%" x2="100%" y2="0%">
      ...
      <Rect width={width} height={height} fill="url(#germanyHeaderGrad)" />
    </Svg>
  </View>
);
...
const GERMANYGameDetailsScreen = ({ route, navigation }) => {
      ...
      if (
        ...
        if (gameId && contextTeamId) {
          try {
            ...
            const rosterUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/ger.1/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster?lang=en&region=us`;
            ...
            if (foundAthleteId) {
              const statsUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/ger.1/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster/${foundAthleteId}/statistics/0?lang=en&region=us`;
              console.log(
  ...
  const getTeamLogo = async (teamId, isDarkMode) => {
    ...
    const logoUrl =
      await GermanyServiceEnhanced.getTeamLogoWithFallback(teamId);
      ...
      >
        ...
        <View style={styles.simpleLeagueRow}>
          <Text
            ...
            numberOfLines={1}
          >
            {gameData.competitionName || "GERMANY World Cup"}
          </Text>
        </View>
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  ...
                  {
                    color: isFavorite(homeTeamData?.team?.id, "bundesliga")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (homeIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(homeTeamData?.team?.id, "bundesliga") ? "★ " : ""}
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  styles.simpleTeamName,
                  {
                    color: isFavorite(awayTeamData?.team?.id, "bundesliga")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (awayIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(awayTeamData?.team?.id, "bundesliga") ? "★ " : ""}
        ...
        {/* Scorers Box (GERMANY-specific addition) */}
  ...
  const fetchLineupData = async (sourceData = null) => {
    ...
    try {
      ...
      console.log("[GERMANYGameDetails] Extracted lineups from summary:", {
