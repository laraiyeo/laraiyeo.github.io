...
const HeaderGradient = ({ awayColor, homeColor, theme, height }) => (
  <View style={[StyleSheet.absoluteFill, { height }]} pointerEvents="none">
    ...
    >
      <Defs>
        <LinearGradient id="fifaHeaderGrad" x1="00%" y1="0%" x2="100%" y2="0%">
      ...
      <Rect width={width} height={height} fill="url(#fifaHeaderGrad)" />
    </Svg>
  </View>
);
...
const FIFAGameDetailsScreen = ({ route, navigation }) => {
      ...
      if (
        ...
        if (gameId && contextTeamId) {
          try {
            ...
            const rosterUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/fifa.world/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster?lang=en&region=us`;
            ...
            if (foundAthleteId) {
              const statsUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/fifa.world/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster/${foundAthleteId}/statistics/0?lang=en&region=us`;
              console.log(
      ...
      >
        ...
        <View style={styles.simpleLeagueRow}>
          <Text
            ...
            numberOfLines={1}
          >
            {gameData.competitionName || "FIFA World Cup"}
          </Text>
        </View>
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  ...
                  {
                    color: isFavorite(homeTeamData?.team?.id, "fifa world")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (homeIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(homeTeamData?.team?.id, "fifa world") ? "★ " : ""}
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  styles.simpleTeamName,
                  {
                    color: isFavorite(awayTeamData?.team?.id, "fifa world")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (awayIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(awayTeamData?.team?.id, "fifa world") ? "★ " : ""}
        ...
        {/* Scorers Box (FIFA-specific addition) */}
  ...
  const fetchLineupData = async (sourceData = null) => {
    ...
    try {
      ...
      console.log("[FIFAGameDetails] Extracted lineups from summary:", {
