...
const FranceGameDetailsScreen = ({ route, navigation }) => {
  ...
  const renderPlayerPopup = () => {
    ...
    if (selectedPlayer.teamType === 'home') {
      teamColor = FranceServiceEnhanced.getTeamColorWithAlternateLogic(homeTeam?.team) || '#007bff';
    } else if (selectedPlayer.teamType === 'away') {
      teamColor = FranceServiceEnhanced.getTeamColorWithAlternateLogic(awayTeam?.team) || '#28a745';
    }
