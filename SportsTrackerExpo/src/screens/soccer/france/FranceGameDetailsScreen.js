...
const HeaderGradient = ({ awayColor, homeColor, theme, height }) => (
  <View style={[StyleSheet.absoluteFill, { height }]} pointerEvents="none">
    ...
    >
      <Defs>
        <LinearGradient id="franceHeaderGrad" x1="00%" y1="0%" x2="100%" y2="0%">
      ...
      <Rect width={width} height={height} fill="url(#franceHeaderGrad)" />
    </Svg>
  </View>
);
...
const FRANCEGameDetailsScreen = ({ route, navigation }) => {
      ...
      if (
        ...
        if (gameId && contextTeamId) {
          try {
            ...
            const rosterUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/fra.1/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster?lang=en&region=us`;
            ...
            if (foundAthleteId) {
              const statsUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/fra.1/events/${gameId}/competitions/${gameId}/competitors/${contextTeamId}/roster/${foundAthleteId}/statistics/0?lang=en&region=us`;
              console.log(
  ...
  const getTeamLogo = async (teamId, isDarkMode) => {
    ...
    const logoUrl =
      await FranceServiceEnhanced.getTeamLogoWithFallback(teamId);
      ...
      >
        ...
        <View style={styles.simpleLeagueRow}>
          <Text
            ...
            numberOfLines={1}
          >
            {gameData.competitionName || "FRANCE World Cup"}
          </Text>
        </View>
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  ...
                  {
                    color: isFavorite(homeTeamData?.team?.id, "ligue 1")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (homeIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(homeTeamData?.team?.id, "ligue 1") ? "★ " : ""}
            ...
            <View style={styles.simpleTeamInfo}>
              <Text
                ...
                style={[
                  styles.simpleTeamName,
                  {
                    color: isFavorite(awayTeamData?.team?.id, "ligue 1")
                      ? colors.primary
                      : theme.text,
                    opacity: matchStatus.isPost ? (awayIsWinner ? 1 : 0.55) : 1,
                  },
                ...
                numberOfLines={2}
              >
                {isFavorite(awayTeamData?.team?.id, "ligue 1") ? "★ " : ""}
        ...
        {/* Scorers Box (FRANCE-specific addition) */}
  ...
  const fetchLineupData = async (sourceData = null) => {
    ...
    try {
      ...
      console.log("[FRANCEGameDetails] Extracted lineups from summary:", {
