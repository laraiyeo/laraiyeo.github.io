        ...
        <View style={styles.matchContent}>
          ...
          <View style={styles.teamSection}>
            ...
            <Text allowFontScaling={false} style={[
              ...
              {isFavorite(homeTeam?.team?.id, 'ligue 1') ? '★ ' : ''}{homeTeam?.team?.abbreviation || homeTeam?.team?.displayName || 'TBD'}
            </Text>
          </View>
          ...
          <View style={styles.teamSection}>
            ...
            <Text allowFontScaling={false} style={[
              ...
              {isFavorite(awayTeam?.team?.id, 'ligue 1') ? '★ ' : ''}{awayTeam?.team?.abbreviation || awayTeam?.team?.displayName || 'TBD'}
            </Text>
          </View>
        </View>
