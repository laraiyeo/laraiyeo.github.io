...
const FranceTransferScreen = ({ navigation, route }) => {
  ...
  const loadTransferData = async () => {
    try {
      ...
      const response = await fetch(
        convertToHttps(
          "https://sports.core.api.espn.com/v2/sports/soccer/leagues/fra.1/transactions?limit=1000"
        )
      );
...
export default FranceTransferScreen;
