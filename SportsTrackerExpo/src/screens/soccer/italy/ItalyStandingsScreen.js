    ...
    return (
      ...
      >
        ...
        <View style={styles.teamContainer}>
          ...
          />
          <Text allowFontScaling={false} style={[styles.teamName, { color: isFavorite(item.team.id, 'serie a') ? colors.primary : theme.text }]} numberOfLines={1}>
            {isFavorite(item.team.id, 'serie a') ? '★ ' : ''}{item.team.displayName}
          </Text>
        </View>
