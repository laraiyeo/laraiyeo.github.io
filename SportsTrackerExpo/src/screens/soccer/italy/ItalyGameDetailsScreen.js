...
const ItalyGameDetailsScreen = ({ route, navigation }) => {
  ...
  const fetchPlayerGameStats = async (playerId, teamId) => {
    ...
    try {
      ...
      const statsUrl = `https://sports.core.api.espn.com/v2/sports/soccer/leagues/ita.1/events/${gameId}/competitions/${gameId}/competitors/${teamId}/roster/${playerId}/statistics/0?lang=en&region=us`;
  ...
  const renderMiniField = (coordinate, coordinate2, eventType = 'gen', teamSide = 'home', teamColor = '#007bff') => {
    ...
    const renderPlayerPopup = () => {
      ...
      if (selectedPlayer.teamType === 'home') {
        teamColor = ItalyServiceEnhanced.getTeamColorWithAlternateLogic(homeTeamData?.team) || '#007bff';
      } else if (selectedPlayer.teamType === 'away') {
        teamColor = ItalyServiceEnhanced.getTeamColorWithAlternateLogic(awayTeamData?.team) || '#28a745';
      }
              ...
              >
                ...
                {shareCardPlay && (() => {
                  ...
                  if (!contextTeamColor && scoringTeam) {
                    ...
                    teamColor = ItalyServiceEnhanced.getTeamColorWithAlternateLogic(scoringTeam) || teamColor;
