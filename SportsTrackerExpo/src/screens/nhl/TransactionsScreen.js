...
const API_URL = 'https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/transactions';
    ...
    return (
      <View style={[styles.row, { borderBottomColor: theme.border }]}>
        ...
        {item.team && item.team.id && (
          <Image source={{ uri: `https://a.espncdn.com/combiner/i?img=/i/teamlogos/nhl/500${isDarkMode ? '-dark' : ''}/${item.team.abbreviation.toLowerCase()}.png&w=200&h=200` }} style={styles.logo} />
        )}
      </View>
    );
  };
