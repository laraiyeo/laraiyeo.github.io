...
async function loadTeams() {
  try {
    // Use ESPN NHL API like other NHL files
    const TEAMS_API_URL = `https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/teams`;
...
async function createTeamCard(team) {
  const logoUrl = `https://a.espncdn.com/i/teamlogos/nhl/500/scoreboard/${team.abbreviation}.png`;

  const abbreviation = team.abbreviation || 'NHL';
  ...
  return `
    <div class="team-card" data-team-id="${team.id}">
      ...
      <div class="team-details">
        ...
        <div class="team-division" style="color: #${team.color || '000000'};">${abbreviation} - NHL</div>
